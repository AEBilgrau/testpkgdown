...
colSdsArma <- function(X, norm_type = 0L) {
    .Call('_testpkgdown_colSdsArma', PACKAGE = 'testpkgdown', X, norm_type)
}

rowSdsArma <- function(X, norm_type = 0L) {
    .Call('_testpkgdown_rowSdsArma', PACKAGE = 'testpkgdown', X, norm_type)
}
...
dmvnormal <- function(x, mu, sigma) {
    .Call('_testpkgdown_dmvnormal', PACKAGE = 'testpkgdown', x, mu, sigma)
}
...
rmvnormal <- function(n, mu, sigma) {
    .Call('_testpkgdown_rmvnormal', PACKAGE = 'testpkgdown', n, mu, sigma)
}

dgmm_loglik <- function(mus, sigmas, pie, z, marginal_loglik) {
    .Call('_testpkgdown_dgmm_loglik', PACKAGE = 'testpkgdown', mus, sigmas, pie, z, marginal_loglik)
}

dgmm_loglik_marginal <- function(mus, sigmas, pie, z, marginal_loglik) {
    .Call('_testpkgdown_dgmm_loglik_marginal', PACKAGE = 'testpkgdown', mus, sigmas, pie, z, marginal_loglik)
}

approx_pnorm <- function(z, mu, sd) {
    .Call('_testpkgdown_approx_pnorm', PACKAGE = 'testpkgdown', z, mu, sd)
}

pgmm_marginal <- function(z, mus, sigmas, pie) {
    .Call('_testpkgdown_pgmm_marginal', PACKAGE = 'testpkgdown', z, mus, sigmas, pie)
}

EStepRcpp <- function(z, mus, sigmas, pie) {
    .Call('_testpkgdown_EStepRcpp', PACKAGE = 'testpkgdown', z, mus, sigmas, pie)
}

...
#'
#' testpkgdown:::dgmcm.loglik(theta, u, marginal.loglik = FALSE)
#' testpkgdown:::dgmcm.loglik(theta, u, marginal.loglik = TRUE)
#'
#' testpkgdown:::dgmm.loglik(theta, z, marginal.loglik = FALSE)
#' testpkgdown:::dgmm.loglik(theta, z, marginal.loglik = TRUE)
#'
#' testpkgdown:::dgmm.loglik.marginal(theta, z, marginal.loglik = FALSE)
#' testpkgdown:::dgmm.loglik.marginal(theta, z, marginal.loglik = TRUE)
#'
#' testpkgdown:::pgmm.marginal(z, theta)
#' testpkgdown:::qgmm.marginal(u, theta)
#' @keywords internal

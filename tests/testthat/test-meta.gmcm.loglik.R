...
u <- SimulateGMCMData(n = n, par = testpkgdown:::tt(tpar, d = 3, positive.rho = TRUE),
                      d = 3, rescale = TRUE, positive.rho = TRUE)$u

ans <- testpkgdown:::meta.gmcm.loglik(tpar = tpar, u = u)
ans2 <-
  testpkgdown:::meta.gmcm.loglik(tpar = testpkgdown:::tt(tpar, d = 3, positive.rho = TRUE),
                          u = u, rescale = FALSE)
